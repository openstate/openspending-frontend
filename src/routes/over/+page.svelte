<script lang="ts">
  import OGPAward from '$lib/assets/ogp-award.jpg'
</script>
...
<div class="card mt-3 mb-3" style="width: 18rem; padding: 10px;">
  <img src="{OGPAward}" style="width: 100%;" alt="Logo Open Government Award" class="card-img-top">
  <div class="card-body">
    <p class="card-text text-center">Winnaar van de <br><a href="https://www.opengovawards.org/2016Results">Open Government Award</a> honorable mention!</p>
  </div>
</div>

<h2>Financiële data van overheden</h2>
<p>
	Bij Nederlandse overheden is een schat aan informatie aanwezig in de financiële administratie.
	Budget, jaarverslagen, inkomsten, bestedingen, ontvangsten en uitgaven geven een kijkje in de
	huishoudboekjes van overheden. Het ontsluiten van deze financiële data zorgt ervoor dat elke
	inwoner toegang heeft tot financiële informatie. Het standaardiseren van deze data maakt het
	mogelijk om vergelijkingen te maken tussen uitgaven van verschillende overheden.
</p>
...
<p>
	In 2013 is Open State gestart met het ontsluiten van financiële data van Amsterdam Stadsdeel
	Centrum in Open Spending. In 2014 benaderde Open State honderden gemeenten, provincies en
	waterschappen met een dataverzoek voor Iv3 gegevens. Dit resulteerde in 2015 in de duurzame
	ontsluiting van alle financiële data van Nederlandse regionale en lokale overheden als open data.
</p>

<p>
	Na een aantal jaar zonder financiering voor Open Spending, wordt in 2023 de vervolgstap gezet: het
	ontsluiten van financiële detaildata. Zo worden de huishoudboekjes van overheden nog
	inzichtelijker en behapbaarder gemaakt voor inwoners. Momenteel zijn we bezig met het samenstellen
	van een kopgroep van overheden die deel willen nemen aan dit traject. Het uiteindelijke doel voor
	2023 is om vanaf Q4 2023 de financiële detaildata van deze kopgroep te publiceren op
	openspending.nl.
</p>

<h3>Alle Iv3-informatie duurzaam ontsloten</h3>

<p>
	Open State houdt de koppeling van Open Spending met het open data portaal van het CBS in stand.
	Meer dan 15.000 rapportages zijn daardoor beschikbaar op openspending.nl waardoor het mogelijk
	wordt om inzicht te krijgen in de financiën van ieders lokale overheid. Daarnaast zijn alle
	overheden met elkaar te vergelijken en kunnen benchmarks uitgevoerd worden.
</p>

<p>
	Deze machine-leesbare data geeft inzicht in de inkomsten en uitgaven in begrotingen en realisaties
